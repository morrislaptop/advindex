...
foreach ($models as $model)
{
	echo "\n";
	echo "\t/**\n";
	echo "\t* @var " . $this->_modelName($model) . "\n";
	echo "\t*/\n";
	echo "\tvar \$" . $this->_modelName($model) . ";\n";				
}
...
?>
	...
	//The Associations below have been created with all possible keys, those that are not needed can be removed<?php
